...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : grey;">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h3>Welcome to</h3>
                  <h1>The GRIP National BANK</h1>
                </div>
              </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2024. Made by <b>Adarsh Narayan Singh</b> <br> Ancro Web Solutions Pvt. Ltd.</p>
      </footer>
